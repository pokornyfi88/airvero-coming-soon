document.addEventListener('DOMContentLoaded', () => {
    ...
    async function initializePage() {
        ...
        const searchWidgetSrc = `//www.travelpayouts.com/widgets/${currentLang}/search.js?marker=${TRAVELPAYOUTS_MARKER_ID}&origin=${originIata}&destination=&searchUrl=search.airvero.com&host=search.airvero.com&powered_by=false`;
